...
-- CREATE INDEX IDX_versions_4 ON versions(description); TODO: Why commented out?
...
CREATE TABLE artifact_version_branches (groupId NVARCHAR(512) NOT NULL, artifactId NVARCHAR(512) NOT NULL, branch NVARCHAR(256) NOT NULL, branchOrder INT NOT NULL, version NVARCHAR(256) NOT NULL);
