...
public interface HandleFactory {
     ...
     * The outermost call represents a transaction boundary, and the handle factory
     * performs commit or rollback automatically. Auto-commit has been turned off.
     * <p>
    ...
    /**
     * This method extends {@see HandleFactory#withHandle(HandleCallback)} to
     * automatically wrap checked exceptions.
     */
    ...
    /**
     * This method extends {@see HandleFactory#withHandle(HandleCallback)} to
     * automatically wrap checked exceptions, and is suitable when no value is being returned.
     */
