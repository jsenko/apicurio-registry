...
public class RegistryDatasourceProducer {
    ...
    public AgroalDataSource produceDatasource() throws SQLException {
        ...
        /*
         * We need to disable auto-commit to have proper transaction rollback,
         * otherwise the data may be in an inconsistent state (e.g. partial deletes),
         * or operations would not be rolled back on exception.
         */
