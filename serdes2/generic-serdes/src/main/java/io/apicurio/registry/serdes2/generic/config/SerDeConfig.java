...
public class SerDeConfig {
     ...
     * writing the schema's Global ID to the message payload. Only used when
     ...
     * {@link SerDeConfig#ENABLE_HEADERS} is 'true'.
     */
     ...
     * applicable when {@link SerDeConfig#ENABLE_HEADERS} is enabled. Default value is
    ...
    public static final String HEADER_KEY_GROUP_ID_OVERRIDE_NAME_DEFAULT = "apicurio.key.groupId";
    ...
    public static final String HEADER_VALUE_GROUP_ID_OVERRIDE_NAME_DEFAULT = "apicurio.value.groupId";
    ...
    public static final String HEADER_KEY_ARTIFACT_ID_OVERRIDE_NAME_DEFAULT = "apicurio.key.artifactId";
    ...
    public static final String HEADER_VALUE_ARTIFACT_ID_OVERRIDE_NAME_DEFAULT = "apicurio.value.artifactId";
    ...
    public static final String HEADER_KEY_VERSION_OVERRIDE_NAME_DEFAULT = "apicurio.key.version";
    ...
    public static final String HEADER_VALUE_VERSION_OVERRIDE_NAME_DEFAULT = "apicurio.value.version";
    ...
    public static final String HEADER_KEY_GLOBAL_ID_OVERRIDE_NAME_DEFAULT = "apicurio.key.globalId";
    ...
    public static final String HEADER_VALUE_GLOBAL_ID_OVERRIDE_NAME_DEFAULT = "apicurio.value.globalId";
    /**
    ...
    public static final String HEADER_KEY_CONTENT_ID_OVERRIDE_NAME_DEFAULT = "apicurio.key.contentId";
    ...
    public static final String HEADER_VALUE_CONTENT_ID_OVERRIDE_NAME_DEFAULT = "apicurio.value.contentId";
    ...
    public static final String HEADER_KEY_CONTENT_HASH_OVERRIDE_NAME_DEFAULT = "apicurio.key.contentHash";
    ...
    public static final String HEADER_VALUE_CONTENT_HASH_OVERRIDE_NAME_DEFAULT = "apicurio.value.contentHash";

    /**
     * Used to override the Kafka message header name used to pass the message type for the message key. Only
     * applicable when {@link SerDeConfig#ENABLE_HEADERS} is enabled. Only used by the JSON Schema serde
    ...
    public static final String HEADER_KEY_MESSAGE_TYPE_OVERRIDE_NAME_DEFAULT = "apicurio.key.msgType";

    /**
     * Used to override the Kafka message header name used to pass the message type for the message value.
     * Only applicable when {@link SerDeConfig#ENABLE_HEADERS} is enabled. Only used by the JSON Schema serde
     * classes. Default value is {@link SerdeHeaders#HEADER_VALUE_MESSAGE_TYPE}.
     */
    public static final String HEADER_VALUE_MESSAGE_TYPE_OVERRIDE_NAME = "apicurio.registry.headers.value.msgType.name";
    public static final String HEADER_VALUE_MESSAGE_TYPE_OVERRIDE_NAME_DEFAULT = "apicurio.value.msgType";
}
