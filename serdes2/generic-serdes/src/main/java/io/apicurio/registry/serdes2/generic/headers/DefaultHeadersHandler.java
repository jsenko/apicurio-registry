...
public class DefaultHeadersHandler implements HeadersHandler {
    ...
    /**
     * @see HeadersHandler#configure(Map, boolean)
     */
    @Override
    ...
    @Override
    public void writeHeaders(GenericHeaders headers, RegistryContentCoord coord) {
    ...
    @Override
    public RegistryContentCoord readHeaders(GenericHeaders headers) {
        ...
        if (globalId != null) {
            return new GlobalIdCoord(globalId);
        } else if (contentId != null) {
            return new ContentIdCoord(contentId);
        } else if (contentHash != null) {
            return new ContentHashCoord(contentHash);
        } else if (groupId != null && artifactId != null && version != null) {
            // TODO Latest version?
            return new GAVCoord(groupId, artifactId, version);
        }
        // spotless:off
        /*
