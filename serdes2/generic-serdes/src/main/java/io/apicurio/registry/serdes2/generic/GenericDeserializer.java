...
public class GenericDeserializer<SCHEMA, DATA> extends GenericSerDe<SCHEMA, DATA> {
     ...
     */
    public GenericDeserializer(GenericSerDeDatatype<SCHEMA, DATA> serDeDatatype,
    ...
    public DATA deserialize(String topic, Headers headers, byte[] data) {
        ...
        // try to read data even if artifactReference has no value, maybe there is a fallbackArtifactProvider
        // configured
    ...
    private SchemaLookupResult<SCHEMA> resolve(String topic, Headers headers, byte[] data,
