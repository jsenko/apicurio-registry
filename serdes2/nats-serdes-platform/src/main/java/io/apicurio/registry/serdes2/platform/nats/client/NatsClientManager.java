package io.apicurio.registry.serdes2.platform.nats.client;

import io.apicurio.registry.serde.SerdeConfig;
import io.apicurio.registry.serde.avro.AvroKafkaSerdeConfig;
import io.apicurio.registry.serdes2.platform.nats.client.config.ConfigurationProvider;
import io.apicurio.registry.serdes2.platform.nats.client.streaming.consumers.NatsConsumer;
import io.apicurio.registry.serdes2.platform.nats.client.streaming.consumers.NatsConsumerImpl;
import io.apicurio.registry.serdes2.platform.nats.client.streaming.producers.NatsProducer;
import io.apicurio.registry.serdes2.platform.nats.client.streaming.producers.NatsProducerImpl;
...
public class NatsClientManager {
    ...
    public static Properties getConsumerConfig(String subject) {
        ...
        config.put(AvroKafkaSerdeConfig.USE_SPECIFIC_AVRO_READER,
                ConfigurationProvider.getString(AvroKafkaSerdeConfig.USE_SPECIFIC_AVRO_READER));
        return config;
    }

    public static Properties getProducerConfig(String subject) { // Making it public, for clients to add
                                                                 // values
        var config = new Properties();
