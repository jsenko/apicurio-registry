...
public class NatsProducerImpl<DATA> implements NatsProducer<DATA> {
    ...
    public NatsProducerImpl(Connection connection, String subject, Properties config) throws Exception {
        ...
        serializer = Utils.newConfiguredInstance(config.get(NatsProducerConfig.SERIALIZER_CLASS_CONFIG),
                NatsSerializer.class, org.apache.kafka.common.utils.Utils.propsToMap(config), null);
